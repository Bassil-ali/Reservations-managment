...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('grade_code',trans('admin.grade_code'),['class'=>' control-label']) !!}
            {!! Form::text('grade_code',old('grade_code'),['class'=>'form-control','placeholder'=>trans('admin.grade_code')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('grade_name',trans('admin.grade_name'),['class'=>' control-label']) !!}
            {!! Form::text('grade_name',old('grade_name'),['class'=>'form-control','placeholder'=>trans('admin.grade_name')]) !!}
    </div>
</div>
