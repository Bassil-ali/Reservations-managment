	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{aurl('user')}}" class="dropdown-item" style="color:#343a40">
				<i class="fas fa-list"></i> {{trans('admin.show_all')}} </a>
				<a href="{{aurl('user/'.$user->id)}}" class="dropdown-item" style="color:#343a40">
				<i class="fa fa-eye"></i> {{trans('admin.show')}} </a>
				<a class="dropdown-item" style="color:#343a40" href="{{aurl('user/create')}}">
					<i class="fa fa-plus"></i> {{trans('admin.create')}}
				</a>
				<div class="dropdown-divider"></div>
				<a data-toggle="modal" data-target="#deleteRecord{{$user->id}}" class="dropdown-item" style="color:#343a40" href="#">
		...
		@push('js')
		<div class="modal fade" id="deleteRecord{{$user->id}}">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('second_name', $user->second_name ,['class'=>'form-control','placeholder'=>trans('admin.second_name')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('direction', $user->direction ,['class'=>'form-control','placeholder'=>trans('admin.direction')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        <div class="custom-control custom-switch">
            {!! Form::checkbox('activation', '1',$user->activation == "1"?true:false ,['class'=>'custom-control-input','placeholder'=>trans('admin.activation'),"id"=>"activation"]) !!}
            {!! Form::label('activation',trans('admin.activation'),['class'=>'custom-control-label']) !!}
        </div>
    </div>
</div>
