  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
         ...
         <img src="{{  asset('storage/' . auth()->guard('client')->user()->photo) }}" class="img-circle elevation-2" alt="{{ auth()->guard('client')->user()->photo}}
        "> 
       
      </div>
      <div class="info">
         <a href="" class="d-block">{{  auth()->guard('client')->user()->username}}
        </a>
      </div>
    </div>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
         ...
         <img src="{{ it()->url(admin()->user()->photo_profile) }}" class="img-circle elevation-2" alt="{{  it()->url(admin()->user()->photo_profile)}}
        "> 
       
      </div>
      <div class="info">
         <a href="" class="d-block">{{  admin()->user()->name}}
        </a>
      </div>
    </div>
