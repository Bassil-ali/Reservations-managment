	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('client/'.$client->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/client/'.$client->id),'method'=>'put','id'=>'client','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('first_name',trans('admin.first_name'),['class'=>'control-label']) !!}
        {!! Form::text('first_name', $client->first_name ,['class'=>'form-control','placeholder'=>trans('admin.first_name')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('second_name',trans('admin.second_name'),['class'=>'control-label']) !!}
        {!! Form::text('second_name', $client->second_name ,['class'=>'form-control','placeholder'=>trans('admin.second_name')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::text('username', $client->username ,['class'=>'form-control','placeholder'=>trans('admin.username')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('direction',trans('admin.direction'),['class'=>'control-label']) !!}
        {!! Form::text('direction', $client->direction ,['class'=>'form-control','placeholder'=>trans('admin.direction')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        <div class="custom-control custom-switch">
            {!! Form::checkbox('activation', '1',$client->activation == "1"?true:false ,['class'=>'custom-control-input','placeholder'=>trans('admin.activation'),"id"=>"activation"]) !!}
