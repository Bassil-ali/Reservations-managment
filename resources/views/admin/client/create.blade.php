	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('client') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/client'),'id'=>'client','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        <div class="custom-control custom-switch">
            {!! Form::checkbox("activation","1",old("activation"),["class"=>"custom-control-input","placeholder"=>trans("admin.1"),"id"=>"activation"]) !!}
            {!! Form::label("activation",trans("admin.1"),["class"=>"custom-control-label"]) !!}
        </div>
    </div>
</div>
